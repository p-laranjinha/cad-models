import os
from build123d import Line, export_step, extrude, make_face
...
inner = inner_left + inner_top + inner_bottom + inner_right
...
outer = outer_left + outer_top + outer_bottom + outer_right
